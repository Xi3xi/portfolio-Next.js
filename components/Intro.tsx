  ...
  return (
    <div className='pb-20 pt-0'>
        ...
        <motion.div
            ...
            className=""
            >
            <div className="h-screen w-full dark:bg-transparent bg-white  dark:bg-grid-white/[0.00] bg-grid-black/[0.00] 
            flex items-center justify-center absolute top-0 left-0">
                {/* Radial gradient for the container to give a faded look */}
                <div className="absolute pointer-events-none inset-0 flex [mask-image:radial-gradient(ellipse_at_center,transparent_20%,black)]"/>
            </div>
